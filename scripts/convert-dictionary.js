...
// Run: node scripts/convert-dictionary.js
//
// Փոխակերպում է հին dictionary-ը նոր օպտիմալ կառուցվածքի
...
class DictionaryConverter {
  ...
  run() {
    LOG.section('🔄 DICTIONARY CONVERTER');
    ...
    console.log('  3. Check: node scripts/scan-dictionaries.js');
  }
}
